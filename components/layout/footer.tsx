        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-400">
              <a href="mailto:admin@vayuxierp.com" className="flex items-start">
              ...
              <a href="tel:+918320554983" className="flex items-start">
                <span className="mr-3 mt-1 text-white">
                  <svg className="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z"></path>
                  </svg>
                </span>
                <span className='underline hover:text-white'>+91-8320554983</span>
              </a>
              <a 
              ...
              >
                ...
                <span className='underline hover:text-white'>183,REEVA RESIDENCY FLYOVER BRIDGE KOSAMBA DIST- SURAT 394120,Gujarat, India</span>
              </a>
            </ul>
          </div>
